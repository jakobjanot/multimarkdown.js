(function() {
    ...
    MultiMarkdown.Renderer.render = function(input, callback) {
        // Allocate space for string and extra '0' at the end
        var buffer = Module._malloc(input.length+1);

        // Write the string to memory
        Module.writeStringToMemory(input, buffer);
        callback(markdown_to_string(input, this._parserExtensionsSum, this._exportFormat));
    };
